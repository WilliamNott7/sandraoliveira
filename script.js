...
const text = "Seja bem-vindo(a) ao meu portfólio. Aqui tens acesso às minhas redes, mídia kit e projetos. Para parcerias e colaborações, clica no botão abaixo 👇";
  let i = 0;
  function typing() {
    if (i < text.length) {
